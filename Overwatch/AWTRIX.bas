...
private Sub Class_Globals
	...
	Private isSimulator As Boolean
End Sub
	...
	Select Case function
		Case "start"
			...
			Try
				...
				End If
				hideicon=False
				If Params.ContainsKey("simulator") Then
					isSimulator=True
		...
		Case "iconList"
			If isActive = False Or isSimulator Then
...
Public Sub throwError(message As String)
	Log(DateTime.Date(DateTime.Now) &"      " & appName & ":" & CRLF &  message)
End Sub
