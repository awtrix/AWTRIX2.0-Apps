...
Public Sub Initialize() As String
	...
	App.Description="Shows Date and the day of the week."
	...
	App.Settings= CreateMap("ShowWeekday":True,"StartsSunday":False,"DateFormat":"DD/MM","WeekdaysColor":"80,80,80","CurrentDayColor":"255,255,255") 'needed Settings for this Plugin
...
Sub App_genFrame
	...
	If App.get("DateFormat")= "MM/DD" Then
		App.drawText(month&"."& day&".",7,1,Null)
	Else
		App.drawText(day&"."& month&".",7,1,Null)
	End If
