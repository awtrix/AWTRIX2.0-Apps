...
Sub App_startDownload(jobNr As Int)
	Select jobNr
		Case 1
			App.Download("https://www.lottoland.com/en/api/drawings/euroJackpot")
	End Select
End Sub
		...
		If Resp.success Then
			Select Resp.jobNr
				Case 1
					...
					Dim nex As Map = root.Get("next")
					jackpot = nex.Get("jackpot")
			End Select
		End If
	Catch
...
Sub App_genFrame
	App.genSimpleFrame(jackpot & " Mio",1481,True,False,Null,True)
End Sub