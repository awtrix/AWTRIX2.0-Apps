...
Sub App_startDownload(jobNr As Int)
	Select jobNr
		Case 1
			App.Download("https://beta.ourmanna.com/api/v1/get/?format=json")
	End Select
End Sub
		...
		If Resp.success Then
			Select Resp.jobNr
				Case 1
					...
					Dim verse As Map = root.Get("verse")
					Dim details As Map = verse.Get("details")
					versetext= details.Get("text")
			End Select
		End If
	Catch
...
Sub App_genFrame
	App.genSimpleFrame(versetext,1493,True,False,Null,True)
End Sub