...
Now send your notifications via MQTT to the topic /mqtt and add the key "ID" with the app ID. The notifications will be saved and displayed continuously so you don't have to actively send the notification. You can overwrite any ID at any time.
	"$
