...
Sub Class_Globals
	...
	Private AppName As String = "Huya" 'change plugin name (must be unique)
    ...
    Private iconID As Int = 598
	
	Private description As String= $"
	This is a app for a Huya.com.<br />
	...
	<b>RoomID:</b>
    <ul>
		<li>Go to https://www.huya.com/XXX</li>
		<li>Find the 'RoomID' at 'https://www.huya.com/XXX'.</li>
		<li>Copy and enter your RoomID</li><br/><br/>
	</ul>
	"$
	
	Private appSettings As Map = CreateMap("RoomID":Null) 'needed Settings for this Plugin, parse Null if this setting should entered bny the user in the Apps Setup
...
Sub startDownload(nr As Int) As String
	...
	Select nr
		Case 1
            URL=("https://huyarenqi.applinzi.com/?room="&roomid)
	End Select
	Return URL
End Sub
...
Sub genFrame As List
    ...
    commandList.add(CreateMap("type":"line","x0":1,"y0":7,"x1":30,"y1":7,"color":Array As Int(98,214,255)))
	Return commandList
End Sub
...
Sub genText(s As String) As Map
	If s.Length>7 Then
		...
		End If
	Else
		Dim command As Map=CreateMap("type":"text","text":s,"x":2,"y":1,"font":"auto","color":Array As Int(207,78,117))
	End If
	Return command
End Sub
