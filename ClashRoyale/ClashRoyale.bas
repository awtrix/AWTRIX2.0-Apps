...
Public Sub Initialize() As String
	...
	App.settings = CreateMap("ShowName":True, "ShowTrophies":True, "ShowBattles":True, "ShowWarDayWins":True, "PlayerTag":"", "ApiKey":"", "TextColor":"255,255,255")
	...
	<b>ShowVersusTrophies:</b>  Show wins/total battles and win rate in %<br/>
	<b>ShowWarStars:</b> Show war day wins<br/>
	...
	App.tags = Array As String("Clash Royale", "Clash", "ClashRoyale")
	
	'How many downloadhandlers should be generated
	App.downloads = 1
	
	'IconIDs from AWTRIXER. You can add multiple if you need more
	App.icons = Array As Int(1543, 1546, 1548, 1547)
...
Sub App_Started
	...
	If error = False Then
		...
		End If
		If App.get("ShowWarDayWins") Then
			Dim frame4 As FrameObject
			frame4.Initialize
			frame4.text = warDayWins
...
Sub App_startDownload(jobNr As Int)
	Select jobNr
		Case 1
			...
			App.Download("https://proxy.royaleapi.dev/v1/players/" & playerTag.Replace("#", "%23"))
	End Select
End Sub
		...
		If Resp.success Then
			...
			Select Resp.jobNr
				Case 1
					...
					warDayWins = root.Get("warDayWins")
					Dim wins As String =  root.Get("wins")
					Dim battleCount As String = root.Get("battleCount")
					battles = wins & "/" & battleCount  & " - " & NumberFormat2(wins * 100 / battleCount, 1, 2, 2, False) & " %"
			End Select
		Else
			error = True
		End If
